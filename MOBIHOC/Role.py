...
class Role:
    ...
    def initial_config_DAG(self):
        config = [[[680.0, 0.21473665529135894, 703.0], [703.0, 0.24641495225807353, 0.0]],
                  [[421.0, 0.1138722130785901, 358.0], [358.0, 0.3868569648957871, 0.0]],
                  [[367.0, 0.22831086945188028, 492.0], [492.0, 0.22032291220529843, 726.0],
                   [726.0, 0.13440075187962164, 0.0]],
                  [[915.0, 0.11108777439854024, 533.0], [533.0, 0.25600038904387235, 0.0]],
                  [[370.0, 0.26627299503940166, 507.0], [507.0, 0.3132144891498894, 533.0],
                   [533.0, 0.23354292297555315, 0.0]],
                  [[675.0, 0.09393877998659829, 615.0], [615.0, 0.08309758984682734, 579.0],
                   [579.0, 0.23274654000329287, 0.0]],
                  [[448.0, 0.11879688054567733, 360.0], [360.0, 0.1365043438351424, 314.0],
                   [314.0, 0.18198836981392857, 495.0], [495.0, 0.12143092821857662, 0.0]],
                  [[394.0, 0.12319942842749239, 322.0], [322.0, 0.06130967061850584, 739.0],
                   [739.0, 0.1450467293260803, 524.0], [524.0, 0.08432436094870596, 0.0]]]
        cpu = [1841591143.0934973, 1994173951.7322304, 2209813899.4424295, 1999684448.1780057, 2177080434.542744,
               1609502181.2368822, 2188853115.9260335, 1546759123.1576855]
        T = [700, 900, 900, 800, 850, 650, 600, 600]
        D = [500, 650, 1000, 500, 850, 600, 550, 950]
        for n in range(self.number_of_user):
